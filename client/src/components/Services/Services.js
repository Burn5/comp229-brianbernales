  ...
  return (
    <Container fluid className="about-section d-flex flex-column justify-content-center min-vh-100">
      <Helmet>
        ...
        <meta name="description" content="Software development services offered by Brian Bernales, including full-stack development, mobile app prototyping, API integration, and custom web features." />
        <meta name="keywords" content="Brian Bernales, Software Developer, Services, Full-Stack Development, API Integration, React, Firebase" />
      </Helmet>
