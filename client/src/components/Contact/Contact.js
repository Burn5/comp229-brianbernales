  ...
  return (
    <div className="contact-wrapper">
      <Helmet>
        ...
        <meta name="description" content="Ways to get in touch with Brian Bernales. Email, phone, and contact form." />
        <meta name="keywords" content="Brian Bernales, contact, email, phone, software developer" />
      </Helmet>
      ...
      <Container fluid className="about-section">
        <Container className="text-center py-5">
          ...
          <p style={{ color: "#aaa", fontSize: "0.9rem", marginTop: "30px" }}>
            I’m back to you in 24 hours… unless the compiler and I are having “words.” 🐛.
          </p>
        </Container>
      </Container>
    </div>
